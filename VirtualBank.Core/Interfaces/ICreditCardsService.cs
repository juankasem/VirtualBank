...
namespace VirtualBank.Core.Interfaces
{
    public interface ICreditCardsService
    {
        ...
        Task<ApiResponse<CreditCardListResponse>> GetCreditCardsByIBANAsync(string iban, CancellationToken cancellationToken = default);
        ...
        Task<ApiResponse<CreditCardResponse>> AddOrEditCreditCardAsync(int creditCardId, CreateCreditCardRequest request, CancellationToken cancellationToken = default);
